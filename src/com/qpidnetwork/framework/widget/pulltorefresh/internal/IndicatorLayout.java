 ...
 *******************************************************************************/
package com.qpidnetwork.framework.widget.pulltorefresh.internal;
...
import com.qpidnetwork.framework.widget.pulltorefresh.PullToRefreshBase;
...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		switch (mode) {
			case PULL_FROM_END:
				inAnimResId = R.anim.pulltorefresh_slide_in_from_bottom;
				outAnimResId = R.anim.pulltorefresh_slide_out_to_bottom;
			...
			case PULL_FROM_START:
				inAnimResId = R.anim.pulltorefresh_slide_in_from_top;
				outAnimResId = R.anim.pulltorefresh_slide_out_to_top;
