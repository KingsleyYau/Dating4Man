...
import com.qpidnetwork.framework.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.LoadingLayout;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.Utils;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * @param enable
	 */
	public void setPullUpToRefreshEnable(boolean enable) {
		switch (mMode) {
		case DISABLED:
			if (enable) {
				setMode(Mode.PULL_FROM_END);
	...
	/**
	 * 显示头部刷新（不触发 onPullDownToRefresh）
	 */
	public void showHeaderRefreshNoEvent() {
