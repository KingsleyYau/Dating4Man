...
import com.qpidnetwork.framework.widget.pinterest.internal.PLA_AdapterView.OnItemClickListener;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.qpidnetwork.framework.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase2<T extends PLA_AbsListView> extends PullToRefreshBase<T> implements
	...
	public PullToRefreshAdapterViewBase2(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshAdapterViewBase2(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshAdapterViewBase2(Context context, Mode mode, AnimationStyle animStyle) {
