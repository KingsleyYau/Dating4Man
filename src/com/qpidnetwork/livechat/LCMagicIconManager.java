...
import com.qpidnetwork.livechat.LCMagicIconDownloader.LCMagicIconDownloaderCallback;
import com.qpidnetwork.livechat.LCMagicIconDownloader.MagicIconDownloadType;
...
public class LCMagicIconManager implements LCMagicIconDownloaderCallback{
	...
	public LCMagicIconManager() {
		...
		mGetMagicIconConfigReqId = RequestJni.InvalidRequestId;
		mDownloadPath = "";
		mDirPath = "";
		mHost = "";
		mCallback = null;
...
// ------------------- 高级表情配置操作 --------------------
	...
	public boolean GetConfigItemWithFile() {
		boolean result = false;
        try {  
        	String key = "MagicIconConfigItem_" + WebSiteManager.getInstance().GetWebSite().getSiteId();
