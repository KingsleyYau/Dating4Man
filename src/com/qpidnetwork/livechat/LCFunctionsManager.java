...
public class LCFunctionsManager {
	...
	public void GetFunctionSetting(final DeviceType deviceType, final String clientVersion, OnGetFunctionSettingCallback callback){
		...
		if(param != null && param.item != null){
			requestId = RequestJniLiveChat.CheckFunctions(getCheckFunctionList(), deviceType, 
					clientVersion, param.item.sessionid, param.item.manid, new OnCheckFunctionsCallback() {
				
				@Override
				public void OnCheckFunctions(boolean isSuccess, String errno,
