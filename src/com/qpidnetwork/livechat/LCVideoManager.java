...
public class LCVideoManager {
	 ...
	 */
	private HashMap<FileDownloader, String> mDownloadVideoMap;
	/**
	 * 正在下载视频map表(videoId, FileDownloader)
	 */
	private HashMap<String, FileDownloader> mVideoDownloadMap;
	/**
	...
	public LCVideoManager() 
	{
		mDirPath = "";
		// 视频下载对照表
		mDownloadVideoMap = new HashMap<FileDownloader, String>();
		mVideoDownloadMap = new HashMap<String, FileDownloader>();
		// 视频图片下载对照表
