...
import com.qpidnetwork.livechat.LCFunctionsManager.OnGetFunctionSettingCallback;
...
public class LCFunctionCheckManager {
	...
	public void CheckFunctionSupported(String womanId){
		...
		if(userItem.chatType == ChatType.InChatCharge || userItem.chatType == ChatType.InChatUseTryTicket){
