		...
		AsyncTask<Object, Void, Object> task = new AsyncTask<Object, Void, Object>(){
			...
			protected Object doInBackground(Object... params) {
				...
				if (heightDifference > 2) {
					...
					bitmap = Bitmap.createBitmap(bitmap, (int)offset, 0, (int)((float)cameraViewHolder.getHeight() * ratio), bitmap.getHeight());
					bitmap = ImageUtil.createRotatedBitmap(getActivity(), bitmap, (cameraView.getCurrentCamera() == cameraView.getFrontCamera()) ? -90 : 90);
				}
				
				String fileUrl = FileCacheManager.getInstance().getPrivatePhotoTempSavePath() + PictureHelper.getPhotoFileName();
				boolean written = ImageUtil.writeBitmapToFile(bitmap, fileUrl);
				bitmap.recycle();
