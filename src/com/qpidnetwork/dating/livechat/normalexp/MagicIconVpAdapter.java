...
public class MagicIconVpAdapter extends FragmentPagerAdapter {
	...
	private void getVpHeigth() {
		...
		mVpHeight = ((ChatActivity)mContext).getKeyboardHeight() - itemWidth-UnitConversion.dip2px(mContext, 20+1);
	}
	...
	public Fragment getItem(int position) {
		...
		if (fragment == null) {
			if (position == 0) {
				...
				fragment = new MagicIconHomeFragment(mVpHeight,mHomeMagicItems);//首页
			} else {
