...
public class MaterialAppBar extends LinearLayout {
	...
	public void addOverflowButton(String[] menu, MaterialDropDownMenu.OnClickCallback listener, int icon) {
		...
		final FrameLayout button = createButton(R.id.imageViewOverFlow, "overflow", icon);
	...
	public FrameLayout createButton(int btnId, String tag, int icon, String name) {
		...
		// create button
		LinearLayout.LayoutParams button_params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, height);
	...
	public void setOnTitleClick(View.OnClickListener l) {
	...
	public void setButtonLayoutParams(String name, LinearLayout.LayoutParams params){
