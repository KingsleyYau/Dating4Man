...
// 私密照列表定义
typedef list<EMFPrivatePhotoItem> EMFPrivatePhotoList;
// 邮件附件URL列表定义
...
typedef list<EMFInboxListItem> EMFInboxList;


// 查询已收邮件详细 EMF_INBOXMSG_PATH(/emf/inboxmsg) item
class EMFInboxMsgItem
{
public:
	EMFInboxMsgItem()
	{
...
typedef list<EMFOutboxListItem> EMFOutboxList;

// 查询已发邮件详细 EMF_OUTBOXMSG_PATH(/emf/outboxmsg)
class EMFOutboxMsgItem
{
public:
	EMFOutboxMsgItem()
	{
...
class EMFUploadImageItem
{
public:
	EMFUploadImageItem() {}
	virtual ~EMFUploadImageItem() {}
...
class EMFUploadAttachItem
{
public:
	EMFUploadAttachItem() {};
	virtual ~EMFUploadAttachItem() {};
...
class EMFDeleteMsgItem
{
public:
	EMFDeleteMsgItem() {}
	virtual ~EMFDeleteMsgItem() {}
...
class EMFAdmirerViewerItem
{
public:
	EMFAdmirerViewerItem()
	{
		id = "";
		body = "";
		womanid = "";
...
typedef list<EMFBlockListItem> EMFBlockList;
...
class EMFUnblockItem
{
public:
	EMFUnblockItem() {}
	virtual ~EMFUnblockItem() {}
