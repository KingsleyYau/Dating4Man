...
APP_ABI	:= armeabi armeabi-v7a x86 arm64-v8a #armeabi-v7a #armeabi #x86 

#NDK_TOOLCHAIN_VERSION = 4.8

#STLPORT_FORCE_REBUILD := true 可以强制重新编译STLPort源码
APP_CFLAGS += -O2 -D_ANDROID #-DPRINT_JNI_LOG -DFILE_JNI_LOG -D_ANDROID -D_CHECK_MEMORY_LEAK#-g -O0 -DPRINT_JNI_LOG -DFILE_JNI_LOG -D_ANDROID -D_CHECK_MEMORY_LEAK#-O2 -D_ANDROID#-DHAVE_PTHREADS -DHAVE_ANDROID_OS=1 -g #-std=c++0x#-std=gnu++0x
