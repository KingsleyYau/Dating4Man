...
APP_ABI	:= armeabi armeabi-v7a arm64-v8a #x86 #armeabi-v7a #armeabi 

#NDK_TOOLCHAIN_VERSION = 4.8

#STLPORT_FORCE_REBUILD := true 可以强制重新编译STLPort源码
APP_CFLAGS += -g -O0 -DPRINT_JNI_LOG -DFILE_JNI_LOG#-O2#-DHAVE_PTHREADS -DHAVE_ANDROID_OS=1 -g #-std=c++0x#-std=gnu++0x
